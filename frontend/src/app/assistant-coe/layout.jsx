...
export default function AssistantCOELayout({ children }) {
  ...
  // ✅ ONLY Assistant COE allowed
  const allowedRoles = ["AssistantCOE"];
      ...
      <div className="min-h-screen flex items-center justify-center bg-red-50">
        <div className="p-6 bg-white rounded-lg shadow text-center">
          ...
          <p className="text-gray-600 mt-2">
            This portal is restricted to Assistant COE only.
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-xl border-r flex flex-col">
        ...
        <div className="h-16 flex items-center px-6 border-b bg-gradient-to-r from-blue-600 to-blue-800">
          <h1 className="text-lg font-semibold text-white">Assistant COE</h1>
        </div>
