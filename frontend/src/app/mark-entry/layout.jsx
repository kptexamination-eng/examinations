...
export default function MarkEntryLayout({ children }) {
  ...
  // ✅ ONLY Mark Entry Case Worker allowed
  const allowedRoles = ["MarkEntryCaseWorker"];
      ...
      <div className="min-h-screen flex items-center justify-center bg-red-50">
        <div className="p-6 bg-white rounded-xl shadow text-center">
          ...
          <p className="text-gray-600 mt-2">
            This portal is restricted to Mark Entry Case Workers only.
          </p>
        </div>
      </div>
    );
