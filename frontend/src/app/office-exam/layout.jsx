...
export default function ExamOfficeLayout({ children }) {
  ...
  // ✅ ONLY Exam Office role allowed
  const allowedRoles = ["OfficeExam"];
      ...
      <div className="min-h-screen flex items-center justify-center bg-red-50">
        <div className="p-6 bg-white rounded-lg shadow text-center">
          ...
          <p className="text-gray-600 mt-2">
            This portal is restricted to Examination Office staff only.
          </p>
        </div>
      </div>
    );
  ...
  const nav = [
    ...
    {
      label: "Members List",
      href: "/office-exam/membersList",
      icon: <Files className="w-5 h-5" />,
    },
    {
      label: "HOD Coordination",
      href: "/office-exam/addHOD",
